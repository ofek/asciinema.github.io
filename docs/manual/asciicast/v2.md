...
JSON](http://jsonlines.org/), recorded by [asciinema cli](../../cli/) (2.0 and
later). 
...
* [asciinema cli](https://github.com/asciinema/asciinema) - 2.0.0
* [asciinema player](https://github.com/asciinema/asciinema-player) - 2.6.0
